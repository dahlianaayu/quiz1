		...
		<div class="container-fluid">
				...
				<div class="table-responsive">
					<table class="table table-hover">
				        ...
				        <tbody>
				         <?php foreach ($jabatan_array as $key): ?>
				          <tr>
				          ...
				          <?php foreach ($pegawai as $nama): ?>
				           ...
				           <td><?php $tanggal = $key['tanggalMulai']; $format = date('d-m-Y', strtotime($tanggal));
             					 echo $format; ?></td>
				           <td><?php $tanggal = $key['tanggalSelesai']; $format = date('d-m-Y', strtotime($tanggal));
             			 		echo $format; ?></td>
				          </tr>
